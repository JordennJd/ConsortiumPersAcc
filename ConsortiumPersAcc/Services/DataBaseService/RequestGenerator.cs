    ...
    static RequestGenerator(){
        switch (Environment.MachineName)
        {
            case ("DESKTOP-AI7DA69"):
                ConnectionSTR = "server=localhost;user=root;database=consortium;password=123123";
                break;
            case ("MacBook-Air-Danil"): 
                ConnectionSTR = "server=localhost;user=root;database=consortium;password=lfybk2000";
                break;
            case ("JORDENN-PC"): 
                ConnectionSTR = "server=localhost;user=root;database=consortium;password=данил2000";
                break;
